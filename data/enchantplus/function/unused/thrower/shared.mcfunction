...
execute anchored eyes positioned ^ ^ ^1 summon minecraft:item_display run function enchantplus:actions/thrower/entity with storage enchantplus:temp thrower
...
schedule function enchantplus:actions/thrower/process_all 1t replace